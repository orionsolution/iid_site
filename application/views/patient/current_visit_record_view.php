<table id="table_list" class="new_record" width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom:5px; border-bottom:solid 2px #ccc;">
          <tr class="headrow">
            <td width="16%">current visit</td>
            <td width="6%">title</td>
            <td width="5%">category</td>
            <td width="41%">details</td>
            <td width="26%" class="last">notes</td>
            <td width="6%" class="last">&nbsp;</td>								
          </tr>
...
<table id="table_list_invest" class="new_record" width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr class="headrow">
	<td width="22%" colspan="2">current investigation</td>
	<!--<td width="3%">title</td>-->
  ...
  ?>
	...
	<div class="update_delete_fancybox">
...
$("#tabbottom #table_list tr.td_header, #tabbottom #table_list_invest tr.td_header").css("background-color", "#eaeaea");
$("#tabbottom #table_list tr.td_header, #tabbottom #table_list_invest tr.td_header").css("color", "#959595");
$(function() {
  $('#tabbottom #table_list tr.td_header, #tabbottom #table_list_invest tr.td_header').hover(function() {
...
<!-- date picker for treatement update fancybox -->



<!-- update and delete functionality for table with id of table list -->
<script>
  $(document).ready(function() {
    /*********************** Update Functionality **************************/

    $('.update_delete_fancybox input[name=update_patient]').click(function() {
	  ...
	  var past_date = $('.modification_date').val();
	  console.log("Update Past date: " + past_date);
	  var data = {
		"past_date": past_date,
		"view_name": "patient/current_visit_record_view"
	  };
    ...
    $('.update_delete_fancybox input[name=edit_patient_treat]').click(function() {
...
//        console.log(end_date);
      ...
      $.post(update_url, update_data, function() {
        console.log('data updated successfully');
        var url = "<?= base_url() ?>patient/past_record/<?= $mrd_no ?>/";
        $.get(url, data, function(data) {
          $("#tabbottom").html(data);
...
//          
    ...
    $('.update_delete_fancybox input[name=delete_patient]').click(function() {
