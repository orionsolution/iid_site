  $(document).ready(function() {
    ...
    $('#tabbottom').on('click', 'a.fancybox_picture', function() {
    ...
    $('#tabbottom input[name=update_patient]').click(function() {
      ...
      if (pi_table_name !== 'investigation') {
        ...
        $.post(update_url, {'info': add_info, 'column_name': column_name}, function() {
          console.log('data updated successfully');
          var url = "<?= base_url() ?>patient/record/<?= $mrd_no ?>/";
          console.log("Url : " + url);
    ...
    $('#tabbottom input[name=edit_patient_treat]').click(function() {
...
//          
    ...
    $('#tabbottom input[name=delete_patient]').click(function() {
